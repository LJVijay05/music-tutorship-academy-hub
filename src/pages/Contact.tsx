...
const Contact = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-20">
        {/* Hero Section */}
        <section className="py-8 md:py-12 bg-gradient-to-r from-red-50 to-gray-50">
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                  <form className="space-y-4">
                    ...
                    <Button className="w-full bg-red-600 hover:bg-red-700 h-10 text-base font-medium rounded-lg">
                      Send Message
                    </Button>
                  </form>
                </div>
              ...
              <div className="space-y-6">
                {/* Contact Information */}
                <div>
                  <h2 className="text-xl md:text-2xl font-bold mb-3 text-gray-900">Get in Touch</h2>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <div>
                        <h3 className="font-semibold text-gray-900 text-sm mb-2">Business Hours (IST)</h3>
                ...
                {/* Quick FAQ */}
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-3">Quick FAQ</h3>
                  <div className="space-y-2">
