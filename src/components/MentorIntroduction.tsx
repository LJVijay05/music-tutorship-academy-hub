            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <div className="grid grid-cols-2 gap-6 pt-8 border-t border-gray-200">
                <div className="text-center lg:text-left">
                  <div className="text-3xl lg:text-4xl font-bold text-red-600 mb-2">500+</div>
                  <div className="text-gray-600 font-medium">Students Mentored</div>
                </div>
                <div className="text-center lg:text-left">
                  <div className="text-3xl lg:text-4xl font-bold text-amber-600 mb-2">10M+</div>
                  <div className="text-gray-600 font-medium">Streams Generated</div>
                </div>
              </div>
              ...
              <div className="pt-6">
                <div className="bg-gradient-to-r from-red-50 to-amber-50 rounded-2xl p-6 border border-red-100">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button className="px-6 py-3 bg-gradient-to-r from-red-600 to-amber-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
                      Start Your Journey
                    </button>
                    <button className="px-6 py-3 border-2 border-red-300 text-red-700 font-semibold rounded-xl hover:bg-red-50 transition-all duration-300">
                      View My Work
                    </button>
                  </div>
                </div>
